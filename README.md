...
- [docs/adr/README.md](docs/adr/README.md) — the index of the twenty decision records, one file per decision, each with its evidence. The baseline is [ADR-0013](docs/adr/0013-browser-baseline-and-fallbacks.md), the package layout [ADR-0011](docs/adr/0011-package-layout-and-adapters.md).
