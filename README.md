...
- Zero runtime dependencies, ESM only, and every subpath sits under a size cap CI enforces: 3.16 kB min+gzip for the core, 1.30 kB to add the React adapter next to it, 3.07 kB for the spatial engine, by `bun run check:size` on 2026-09-23 ([ADR-0017](docs/adr/0017-size-budgets.md)). You pay for what you import and nothing else.
