...
below records it: 318 passed and 1 skipped across 22 test files.
...
`bun run test:browser` → 218 passed and 1 skipped in 12 files. 318 passed, 1 skipped in total,
...
- Suite counts, this repository, 2026-09-20: `bun run test:unit` → 100 passed in 10 files;
  `bun run test:browser` → 218 passed, 1 skipped, in 12 files. The skip is
