...
- Fixtures in this repository: `src/spatial/spatial.browser.test.ts:648-696`, the
  ...
  carrying the trap they pin. Suite state at HEAD: `bun run test:unit` → 118 passed in
  12 files; `bun run test:browser` → 359 passed and 1 skipped in 16 files, the skip being the
