...
- Fixtures in this repository: `src/spatial/spatial.browser.test.ts:648-696`, the
  ...
  carrying the trap they pin. Suite state at HEAD: `bun run test:unit` → 119 passed in
  13 files; `bun run test:browser` → 403 passed and 1 skipped in 17 files, the skip being the
