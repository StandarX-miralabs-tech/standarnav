...
- Fixtures in this repository: `src/spatial/spatial.browser.test.ts:583-631`, the
  ...
  carrying the trap they pin. Suite state at HEAD: `bun run test:unit` → 127 passed in
  12 files; `bun run test:browser` → 257 passed and 1 skipped in 13 files, the skip being the
