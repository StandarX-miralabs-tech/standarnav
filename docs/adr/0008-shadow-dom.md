...
skipped test in the suite (`bun run test:browser` → 240 passed, 1 skipped in 12 files),
...
- The skipped fixture: `src/spatial/spatial.browser.test.ts:855-877`, one `it.skip` at `:856`
  naming this ADR. `bun run test:browser` → 240 passed, 1 skipped in 12 files; that skip is this
